...
export const allProducts = {
  vegetables: [
    ...
    {
      id: "v2", name: "Onion", weight: "1 kg", price: 35, originalPrice: 45,
  ...
  fruits: [
    ...
    },
    {
      ...
      description: "Crisp and sweet Royal Gala apples imported from Himachal Pradesh. Perfect for snacking.",
  ...
  snacks: [
    {
      id: "sn1", name: "Too Yumm Chips", weight: "82 g", price: 40,
